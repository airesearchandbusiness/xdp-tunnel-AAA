...
typedef FrameResult (*WrapFn)(const uint8_t *payload, size_t payload_len, uint8_t *out,
                              size_t out_cap, const FrameContext *ctx);

typedef FrameResult (*UnwrapFn)(const uint8_t *frame, size_t frame_len, uint8_t *out,
                                size_t out_cap);
